...
import com.mdt.backend.dto.FileRequestDto;
import com.mdt.backend.dto.FileResponseDto;
...
public class FileController {
    ...
    @PostMapping("/file")
    public FileResponseDto generatePresignedUrl(@RequestBody FileRequestDto request) {
        String presignedUrl = s3Service.generatePresignedUrl(request.getFilePath(), false);
        return new FileResponseDto("Presigned URL 생성 성공", presignedUrl);
    }
